...
{\large
	\begin{tabular}{ll}
		...
		Word Count:         & \bf 11502 \footnote{WC}  \\
...
The original aim was to write a compiler from a subset of OCaml to WebAssembly. I would performing type-inference, transform the typed AST through a series of intermediate representations, and generate a WebAssembly module which could be loaded in a browser such as Firefox. Possible extensions included expanding the OCaml subset, and implementing optimisations.
