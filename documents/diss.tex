...
\\\\
Additionally, WebAssembly memory use was benchmarked, by comparing the \wainline{$mem_idx} global variable, indicating the address of the next free memory, before and after benchmarks were executed. Finally, by using the \textinline{wc} command line counts of the sample directory were also obtained. Memory and line-count results are shown in figure \ref{fig:memlenbenchmark}.
...
\begin{figure}[h]
	...
	xticklabels={REPL, Byte, JS, Nat, Otwa, NRE, NTC, NIRO, NDC, NSC},
	minor y tick num=4,
	ymin=0,
	...
	\addplot+[ boxplot prepared={lower whisker=1.8, lower quartile=1.8, median=2.4459999999999997, upper quartile=3.2319287499512948, upper whisker=3.8  }, ] coordinates {};
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Time Benchmark Results for GCD and Primes}
...
\begin{figure}[h]
	...
	width=\linewidth,
	height=0.6\linewidth,
	title=Relative Memory Usage (WebAssembly Memory Area),
	xlabel=Environment,
	ylabel=Relative Memory Usage \%,
	xtick={1,2,3,4,5},
	xticklabels={Otwa, NRE, NTC, NIRO, NDC=NSC},
	nodes near coords,
...
%	\addplot coordinates {(1,26.9) (2,29.0) (3,26.9) (4,26.9) (5,82.3)};
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Memory and Code Length Benchmark Results}
	\label{fig:memlenbenchmark}
\end{figure}
